<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
      ...
      $queryImage = "SELECT post_image From successpost WHERE post_id = '$id'";
    ...
    //  unlink("../../uploads/images/frontpost/".$oldImage);
      ...
      if(isset($_FILES["newImage"])){
        ...
        if($newFileEXT == "jpg" || $newFileEXT == "png" || $newFileEXT == "jpeg"){
          //Let free storage from delete old image from DB
          unlink("../../uploads/images/successpost/".$oldImage);
          ...
          if(move_uploaded_file($_FILES["newImage"]["tmp_name"],$targetDirectory)){
            $query = "UPDATE successpost SET post_title = ?,post_message = ?,post_image = ?,post_date= NOW() WHERE post_id = ?";
