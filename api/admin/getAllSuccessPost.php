<?php
	...
	$postArray = array();
	$counter = 1;
	$query = "SELECT * FROM successpost";
	$result = $database->query($query);

	if($result -> num_rows > 0){
		echo "<table class='table table-bordered table-hover'>
				<h5><strong>Success Post Items</strong></h5><hr>
      ...
      $postArray["image"]  = $row["post_image"];
			...
			echo "
					<tr>
						...
						<td>$itemTime</td>
						<td>
							<span class='action-edit'><i class='fa fa-pencil action-edit' onclick='viewSuccess($postObj)'></i></span>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <span class='action-delete'><i class='fa fa-trash-o action-delete' onclick='deleteSuccess($postObj)'></i></span>
						</td>
					</tr>
				";
        $counter++;
		...
		echo "
				...
				<h4>There Are No Success Posts Available</h4>
